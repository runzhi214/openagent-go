...
//     can be retrieved semantically — this is memory, not chat history.
//
...
func main() {
	...
	// Layer 1: Recent (working window — last N messages)
	...
	// Layer 2: Compressed (summary of older turns)
	...
	// Layer 3: Search (semantic / full-text from the archive)
